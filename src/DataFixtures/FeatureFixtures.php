...
class FeatureFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $feature->setLanguage('ruby');
        $feature->setName('Modal');
        $this->addReference('feature_30', $feature);
        $manager->persist($feature);
        
        $feature = new Feature();
        $feature->setLanguage('php');
        $feature->setName('Carousel');
        $this->addReference('feature_31', $feature);
        $manager->persist($feature);
        ...
        $feature->setLanguage('java');
        $feature->setName('Carousel');
        $this->addReference('feature_33', $feature);
        $manager->persist($feature);
        
        $feature = new Feature();
        $feature->setLanguage('C#');
        $feature->setName('Carousel');
        $this->addReference('feature_34', $feature);
        $manager->persist($feature);
        
        $feature = new Feature();
        $feature->setLanguage('ruby');
        $feature->setName('Carousel');
        $this->addReference('feature_35', $feature);
        $manager->persist($feature);
        ...
        $feature->setLanguage('js');
        $feature->setName('API REST');
        $this->addReference('feature_37', $feature);
        $manager->persist($feature);
        
        $feature = new Feature();
        $feature->setLanguage('java');
        $feature->setName('API REST');
        $this->addReference('feature_38', $feature);
        $manager->persist($feature);
        ...
        $feature->setLanguage('ruby');
        $feature->setName('API REST');
        $this->addReference('feature_40', $feature);
        $manager->persist($feature);
